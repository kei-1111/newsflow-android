...
@Composable
private fun SortBy.toDisplayString(): String = when (this) {
    SortBy.RELEVANCY -> stringResource(R.string.search_option_sort_relevancy)
    SortBy.POPULARITY -> stringResource(R.string.search_option_sort_popularity)
    SortBy.PUBLISHED_AT -> stringResource(R.string.search_option_sort_newest)
}

@Composable
private fun DateRangePreset.toDisplayString(): String = when (this) {
    DateRangePreset.ALL -> stringResource(R.string.search_option_date_all)
    DateRangePreset.LAST_24_HOURS -> stringResource(R.string.search_option_date_last_24_hours)
    DateRangePreset.LAST_WEEK -> stringResource(R.string.search_option_date_last_week)
    DateRangePreset.LAST_MONTH -> stringResource(R.string.search_option_date_last_month)
}

@Composable
private fun SearchLanguage.toDisplayString(): String = when (this) {
    SearchLanguage.ALL -> stringResource(R.string.search_option_language_all)
    SearchLanguage.ENGLISH -> stringResource(R.string.search_option_language_english)
    SearchLanguage.JAPANESE -> stringResource(R.string.search_option_language_japanese)
}
